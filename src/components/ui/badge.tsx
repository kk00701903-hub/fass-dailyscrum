...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-slate-200 focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-gray-200 bg-slate-100 text-slate-700",
        secondary:
